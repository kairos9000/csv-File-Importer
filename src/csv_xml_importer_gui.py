...
class gui(reader_and_gui_interface):
    ...
    def setFileEncoding(self, return_event):
        ...
        try:
            ...
            showerror("Error!", "Please select a File from the listbox to set the encoding for")
    ...
    def setFileDelimiter(self, return_event):
        ...
        try:
            ...
            showerror("Error!", "Please select a File from the listbox to set the delimiter for") 
        self.root.focus_set()    
        self.updatePreview()
    ...
    def setFileQuotechar(self, return_event):
        ...
        try:
            ...
            showerror("Error!", "Please select a File from the listbox to set the quoting character for") 
        self.root.focus_set()    
        self.updatePreview()
    ...
    def setFileHeader(self):
        ...
        try:
            ...
            showerror("Error!", "Please select a File from the listbox to set the header for") 
        self.root.focus_set()    
        self.updatePreview()
    ...
    def setFileSkipSpaces(self):
        ...
        try:
            ...
            showerror("Error!", "Please select a File from the listbox to set if the spaces should be skipped")
        self.root.focus_set()    
        self.updatePreview()
    ...
    def setFileLineTerminator(self, return_event):
        ...
        try:
            ...
            showerror("Error!", "Please select a File from the listbox to set the line Terminator for") 
        try: 
            self.root.focus_set()    
            self.updatePreview()
    ...
    def setFileQuoting(self):
        ...
        try:
            ...
            showerror("Error!", "Please select a File from the listbox to set the quoting style for")
        self.root.focus_set()    
        self.updatePreview()
    ...
    def csvReset(self):
        ...
        try:
            ...
            showerror("Error!", "Please select a File from the listbox to reset")
            return
